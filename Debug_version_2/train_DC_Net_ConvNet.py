...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_root",type=str, default='../../models/new_models/', help="Path to model saving files")
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    title = opt.model_root + 'DC_Net_' + train_type+suffix    
    print(title)
   ...
   #- save training history
    ...
    train_path = opt.model_root+'TRAIN_'+train_type+suffix+'.pkl'
