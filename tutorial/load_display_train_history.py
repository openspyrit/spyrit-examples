...
#file_path = "../../model/TRAIN_pinv-net_unet_imagenet_N0_10_m_hadam-split_N_128_M_4096_cont-epo15_epo_15_lr_0.001_sss_10_sdr_0.5_bs_128_reg_1e-07.pkl"
file_path = "../../model/TRAIN_lpgd_unet_imagenet_N0_10_m_hadam-split_N_128_M_4096_epo_30_lr_0.001_sss_10_sdr_0.5_bs_128_reg_1e-07_uit_6.pkl"
...
path_save = os.path.join(save_path, name_save + '.png')
fig = plt.figure()
plt.plot(train_loss, label='Training Loss')
plt.plot(val_loss, label='Validation Loss')
plt.xlabel('Epochs')
plt.legend()
fig.savefig(path_save,  bbox_inches='tight', dpi=120)
print('Ptot saved as ' + os.path.abspath(path_save) + '.png')
