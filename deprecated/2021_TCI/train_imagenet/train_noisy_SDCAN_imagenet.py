...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_recon",      type=str,  default='ConvNet', help="Tell which denoiser is used")
...
#         torch.utils.data.DataLoader(testset, batch_size=opt.batch_size,shuffle=False)
    ...
    title = opt.model_root + opt.model_recon + '_' + net_type[opt.net_arch]+train_type+recon_type+suffix    
    print(title)
