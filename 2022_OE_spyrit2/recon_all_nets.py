# -*- coding: utf-8 -*-
"""
Created on Thu Sep  8 18:33:42 2022
...
if save_root:
    ...
    full_path_pinv = save_root / data_folder /net_title / (data_file_prefix + f'_pinv_M_{M}')
    full_path_mmse = save_root / data_folder /net_title / (data_file_prefix + f'_mmmse_M_{M}')
...
if save_root:
    (save_root/data_folder/net_title).mkdir(parents=True, exist_ok=True)
    full_path = save_root / data_folder / net_title / (data_file_prefix + f'_pinv_M_{M}.png')
...
if save_root:
    (save_root/data_folder/net_title).mkdir(parents=True, exist_ok=True)
    full_path = save_root / data_folder / net_title / (data_file_prefix + f'_mmse_M_{M}.png')
    fig.savefig(full_path)
