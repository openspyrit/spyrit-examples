...
# %% DEFORMATION FILES
deform_root = Path('../omigod_res/extendedFOV2')

deform_folder = data_folder
deform_prefix = 'star'

id_files = [
    "695e686b4c0b0d3d4bc70152",  # obj_motion_Diag-UL-BR_starSector_DoF-811_source_white_LED_f80mm-P2_Walsh_im_64x64_ti_1.5ms_zoom_x1 deformations fields
]
try:
