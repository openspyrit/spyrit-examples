...
meas_op.build_H_dyn(aff_field, warping=False, mode=no_warp_interp)
...
for warp_interp_ind, warp_interp in enumerate(warp_interp_list):
    meas_op.build_H_dyn(aff_field_inverse, warping=True, mode=warp_interp)
...
# eta_list = [1e-10, 1e-7, 1e-4, 1e-1, 1, 1e1, 1e2, 1e3]
