...
id_files = [
    "6690f4cc7c2d35c7ba3b4083",  # obj_motion_Diag-UL-BR_DoF-811_pinhole_outFOV_source_white_LED_f80mm-P2_Walsh_im_64x64_ti_2ms_zoom_x1
...
if n_wav > 1:
    ...
    plot_hs(strategy, f_stat_np, wav, suptitle="Static Reconstruction - Spectral Bands", save_fig=save_fig, 
            results_root=results_root, data_folder=data_folder)
