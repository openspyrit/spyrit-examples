...
recon = 'pinv_shift' # 'pinv' 'tikhonet50_div1.5'
...
for z, t in enumerate(z_list):
    ...
    # The color we provide gives RGB values in order, between 0 and 1
    im_filt_1 = colorize(test[..., 1], (1, 0, 1), sat)
    im_filt_2 = colorize(test[..., 0], (0, 1, 1), sat)
...
for z, t in enumerate(z_list):
    ...
    # The color we provide gives RGB values in order, between 0 and 1
    im_unmix_all[...,0,:] = colorize(test[..., 1], (0, 1, 1), sat)
    im_unmix_all[...,1,:] = colorize(test[..., 0], (1, 0, 1), sat)
...
for z, t in enumerate(z_list):
    ...
    # The color we provide gives RGB values in order, between 0 and 1
    im_filter_all[...,0,:] = colorize(test[..., 0], (0, 1, 1), sat)
    im_filter_all[...,1,:] = colorize(test[..., 1], (1, 0, 1), sat)
