...
#%% Tikhonet, 10 photons, Experimental patterns
from spyrit.core.train import read_param, Train_par
from pathlib import Path
import matplotlib.pyplot as plt
...
save_tag = True
model_folder = './model/'
suffix = 'tikho-net_unet_imagenet_ph_10_exp_N_512_M_128_epo_20_lr_0.001_sss_10_sdr_0.5_bs_20_reg_1e-07'
...
#%% Tikhonet, 50 photons, Experimental patterns
from spyrit.core.train import read_param, Train_par
from pathlib import Path
import matplotlib.pyplot as plt
...
save_tag = True
model_folder = './model/'
suffix = 'tikho-net_unet_imagenet_ph_50_exp_N_512_M_128_epo_20_lr_0.001_sss_10_sdr_0.5_bs_20_reg_1e-07'
