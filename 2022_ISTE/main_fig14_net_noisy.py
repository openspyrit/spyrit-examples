# -*- coding: utf-8 -*-
"""
Created on Fri Jan 28 18:19:57 2022
...
# 50 photons
model_root = './models/'
title_50  = 'NET_c0mp_N0_50.0_sig_0.0_Denoi_N_64_M_1024_epo_40_lr_0.001_sss_20_sdr_0.2_bs_256_reg_1e-07'

# 10 photons
model_root = './models/'
title_10  = 'NET_c0mp_N0_10.0_sig_0.0_Denoi_N_64_M_1024_epo_40_lr_0.001_sss_20_sdr_0.2_bs_256_reg_1e-07'

# 2 photons
model_root = './models/'
title_2  = 'NET_c0mp_N0_2.0_sig_0.0_Denoi_N_64_M_1024_epo_40_lr_0.001_sss_20_sdr_0.2_bs_256_reg_1e-07'
...
for ph_i, ph_v in enumerate(ph):
    ...
    #-- Meas
    model = DenoiCompNet(img_size, M, Mean, Cov, variant=0, N0=ph_v, H=H)
...
plt.savefig("dcnet_robustness.pdf", bbox_inches=0)